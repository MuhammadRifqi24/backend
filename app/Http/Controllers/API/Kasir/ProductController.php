...
class ProductController extends Controller
{
    ...
    public function __construct(Services\Rifqi\ProductService $productService, Services\CafeService $cafeService)
    {
    ...
    public function insert(Requests\Kasir\StoreProductRequest $request): JsonResponse
    {
        $auth = $request->user();
    ...
    public function update(Requests\Kasir\UpdateProductRequest $request): JsonResponse
    {
    ...
    public function destroy(Requests\Kasir\DeleteProductRequest $request): JsonResponse
    {
        $checkData = $this->productService->getDataByID($request->uuid, 'uuid');
        if ($checkData['status'] == false) {
