...
class RawMaterialStockController extends Controller
{
    ...
    public function incrementData(Requests\Owner\StoreRawMaterialStockRequest $request, $uuid): JsonResponse
    {
    ...
    public function decrementData(Requests\Owner\StoreRawMaterialStockRequest $request, $uuid): JsonResponse
    {
