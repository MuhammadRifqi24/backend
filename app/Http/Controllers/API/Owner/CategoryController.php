...
class CategoryController extends Controller
{
    ...
    public function insert(Requests\Owner\StoreCategoryRequest $request): JsonResponse
    {
        $auth = $request->user();
    ...
    public function update(Requests\Owner\UpdateCategoryRequest $request): JsonResponse
    {
