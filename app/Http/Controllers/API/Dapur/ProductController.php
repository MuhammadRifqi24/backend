...
class ProductController extends Controller
{
    ...
    public function __construct(Services\Manda\ProductService $productService, Services\CafeService $cafeService)
    {
    ...
    public function insert(Requests\Dapur\StoreProductRequest $request): JsonResponse
    {
        $auth = $request->user();
    ...
    public function update(Requests\Dapur\UpdateProductRequest $request): JsonResponse
    {
    ...
    public function destroy(Requests\Dapur\DeleteProductRequest $request): JsonResponse
    {
        $checkData = $this->productService->getDataByID($request->uuid, 'uuid');
        if ($checkData['status'] == false) {
