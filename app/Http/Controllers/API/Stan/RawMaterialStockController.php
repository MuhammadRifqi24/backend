...
class RawMaterialStockController extends Controller
{
    ...
    public function incrementData(Requests\Stan\StoreRawMaterialStockRequest $request, $uuid): JsonResponse
    {
    ...
    public function decrementData(Requests\Stan\StoreRawMaterialStockRequest $request, $uuid): JsonResponse
    {
