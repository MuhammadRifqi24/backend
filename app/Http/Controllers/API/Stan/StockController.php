...
class StockController extends Controller
{
    ...
    public function incrementData(Requests\Stan\StoreStockRequest $request, $uuid): JsonResponse
    {
    ...
    public function decrementData(Requests\Stan\StoreStockRequest $request, $uuid): JsonResponse
    {
