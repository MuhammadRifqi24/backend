...
class RawMaterialCategoryController extends Controller
{
    ...
    public function insert(Requests\Stan\StoreRawMaterialCategoryRequest $request): JsonResponse
    {
    ...
    public function update(Requests\Stan\UpdateRawMaterialCategoryRequest $request): JsonResponse
    {
    ...
    public function destroy(Requests\Stan\DeleteRawMaterialCategoryRequest $request): JsonResponse
    {
        $checkData = $this->rawMaterialCategoryService->getDataByID($request->uuid, 'uuid');
        if ($checkData['status'] == false) {
