...
class RawMaterialCategoryController extends Controller
{
    ...
    public function insert(Requests\StoreRawMaterialCategoryRequest $request): JsonResponse
    {
    ...
    public function update(Requests\UpdateRawMaterialCategoryRequest $request): JsonResponse
    {
    ...
    public function destroy(Requests\DeleteRawMaterialCategoryRequest $request): JsonResponse
    {
        $checkData = $this->rawMaterialCategoryService->getDataByID($request->uuid, 'uuid');
        if ($checkData['status'] == false) {
