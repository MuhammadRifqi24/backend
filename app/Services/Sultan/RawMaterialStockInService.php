...
class RawMaterialStockInService
{
        ...
        try {
            ...
            switch ($ket) {
                case 'cafe_id':
                    ...
                    if ($cafeManagement) {
                        $message .= ' by CafeId';
                        $result = Models\RawMaterialStockIn::whereHas('raw_material_stock.raw_material', function ($query) use ($cafeManagement) {
                ...
                case 'stan_id':
                    ...
                    break;
                default:
                    $result = Models\RawMaterialStockIn::where('uuid', $id)->first();
                    break;
            }
        } catch (\Throwable $e) {
            $code = 500;
